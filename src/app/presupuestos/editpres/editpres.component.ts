...
export class EditpresComponent implements OnInit {
  ...
  constructor(private pf: FormBuilder, private presupuestoService: PresupuestosService,
              private router: Router, private activatedRouter: ActivatedRoute, private proveedoresService: ProveedoresService) { 
    ...
    activatedRouter.params.subscribe(parametros => {
      ...
      presupuestoService.getPresupuesto(this.id).subscribe(presupuesto => this.presupuesto = presupuesto)
    });
  }
